  ...
  return (
    <div className="interview-page">
      <div className="interview-layout">
        ...
        <aside className="interview-sidebar interview-sidebar--desktop">
          {/* Match Score */}
      ...
      {/* ── Mobile: Score + Skill Gaps + Download ── */}
      <div className="mobile-info-strip">
        <div className="mobile-info-strip__score">
          <div
            className={`match-score__ring match-score__ring--sm ${scoreColor}`}
          >
            <span className="match-score__value">{report.matchScore}</span>
            <span className="match-score__pct">%</span>
          </div>
          <div className="mobile-info-strip__score-text">
            <p className="mobile-info-strip__label">Match Score</p>
            <p className="match-score__sub">Strong match for this role</p>
          </div>
        </div>

        <div className="mobile-info-strip__gaps">
          <p className="skill-gaps__label">Skill Gaps</p>
          <div className="skill-gaps__list">
            {report.skillGaps.map((gap, i) => (
